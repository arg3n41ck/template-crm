...
export const getDefaultConfig = () => {
  ...
  const scaleInset = () =>
    [isFraction, 'full', 'auto', ...scaleUnambiguousSpacing()] as const
  ...
  const scaleAlignSecondaryAxis = () =>
    ['start', 'end', 'center', 'stretch'] as const
  ...
  const scaleColor = () =>
    [themeColor, isArbitraryVariable, isArbitraryValue] as const
  const scaleGradientStopPosition = () =>
    [isPercent, isArbitraryLength] as const
  const scaleRadius = () =>
    [
  ...
  const scaleRotate = () =>
    ['none', isNumber, isArbitraryVariable, isArbitraryValue] as const
  const scaleScale = () =>
    ['none', isNumber, isArbitraryVariable, isArbitraryValue] as const
  const scaleSkew = () =>
    [isNumber, isArbitraryVariable, isArbitraryValue] as const
  const scaleTranslate = () =>
    [isFraction, 'full', ...scaleUnambiguousSpacing()] as const
