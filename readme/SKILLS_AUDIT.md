...
- **AgentDB / Flow Nexus / swarm / Ruflo v3:** инфраструктурные навыки конкретного рантайма, не часть CRM-продукта.
...
| `best-powers`                       | Bootstrap any folder with the full Ruflo / Claude Code "best powers".                                                                           | Не нужен SPA-шаблону      |
...
| `ruflo-bootstrap`                   | Initialize and activate the Ruflo multi-agent runtime in this project.                                                                          | Не нужен SPA-шаблону      |
...
| `swarm-run`                         | Run a real, VISIBLE multi-agent swarm for a task by orchestrating it through the built-in ultracode Workflow tool, while using ruflo (claude-f… | Не нужен SPA-шаблону      |
